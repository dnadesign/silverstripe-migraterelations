...
namespace DNADesign\Migration\Tasks;
    ...
    public function performMigration()
    {
        ...
        if ($db_field) {
            ...
            foreach ($db_field as $field) {
                $result .= $this->migrateSimple($field['owner_current'], $field['owner_new'],
                    $field['field_name_current'], $field['field_name_new'], $field['field_type']);
            }
        }
        ...
        if ($has_one) {
            ...
            foreach ($has_one as $field) {
                    $result .= $this->migrateSimple($field['owner_current'], $field['owner_new'],
                        $field['field_name_current'], $field['field_name_new']);
            }
        }
